...
export function PlaybackRateButton({ player }: { player: PlayerAPI }) {
  ...
  return (
    <button
      type="button"
      className="relative flex h-6 w-6 items-center justify-center rounded-md text-[#111111] hover:text-[#111111] focus:outline-none focus:ring-2  focus:ring-offset-none"
      onClick={() => {
