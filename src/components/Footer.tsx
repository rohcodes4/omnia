...
const Footer = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full flex justify-center z-10">
      <div className="w-full max-w-[1440px] md:h-[96px] h-full md:px-8 md:py-6 px-8 pb-8 flex md:flex-row flex-col-reverse md:justify-between justify-center items-start md:gap-0 gap-6">
        <motion.div
        ...
        <motion.div
          className="flex items-center gap-8 w-[140px] md:w-auto justify-between md:justify-start"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          {socialIcons.map(({ id, iconSrc, href, label }) => (
            <motion.a
              ...
              className="w-[14px] h-[14px] hover:text-[#3246DC] transition-colors duration-300"
